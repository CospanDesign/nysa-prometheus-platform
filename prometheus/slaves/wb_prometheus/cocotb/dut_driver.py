...
class wb_prometheusDriver(driver.Driver):

    """ wb_prometheus

        Communication with a DutDriver wb_prometheus Core
    """
    @staticmethod
    def get_abi_class():
        return 0
    ...
    def __init__(self, nysa, urn, debug = False):
        super(wb_prometheusDriver, self).__init__(nysa, urn, debug)
